    ...
    <div class="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
      <div class="lg:col-span-1">
        <h2 class="font-bold text-2xl md:text-3xl text-gray-800 dark:text-neutral-200">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius facilis omnis, eos at deleniti voluptas
        </h2>
        <p class="mt-2 md:mt-4 text-gray-500 dark:text-neutral-500">
          Lorem, ipsum Lorem ipsum dolor sit amet Lorem ipsum dolor sit, amet consectetur adipisicing elit. Natus.
        </p>
      </div>
      <!-- End Col -->
